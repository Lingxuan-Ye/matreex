...
use super::super::order::{Order, RowMajor};
    ...
    O: Order,
{
    ...
    fn try_from_rows(value: [[T; C]; R]) -> Result<Self> {
        ...
        let (layout, size) = Layout::<T, RowMajor>::from_shape(shape)?;
...
#[cfg(test)]
mod tests {
    use super::super::super::order::ColMajor;
    use super::*;
    use crate::dispatch_unary;
    use alloc::vec;

    #[test]
    fn test_try_from_rows() -> Result<()> {
        ...
        dispatch_unary! {{
            ...
            let output = Matrix::<i32, O>::try_from_rows(seq)?;
    ...
    #[test]
    fn test_from_row_iter() -> Result<()> {
        let expected = Matrix::<i32, RowMajor>::try_from_rows([[1, 2, 3], [4, 5, 6]])?;
